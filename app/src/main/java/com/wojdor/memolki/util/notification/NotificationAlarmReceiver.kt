...
import com.wojdor.memolki.util.notification.NotificationScheduler.Companion.DAILY_NOTIFICATION_ID
...
import com.wojdor.memolki.util.notification.NotificationScheduler.Companion.TYPE_DAILY
...
class NotificationAlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (type) {
            TYPE_DAILY -> handleDailyNotification(context, entryPoint)
    ...
    private fun handleDailyNotification(
        ...
        val titles = context.resources.getStringArray(R.array.notification_daily_titles)
        val bodies = context.resources.getStringArray(R.array.notification_daily_bodies)
        ...
        showNotification(context, DAILY_NOTIFICATION_ID, title, body, contentIntent)
    }
